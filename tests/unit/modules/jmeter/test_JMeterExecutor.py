...
class TestJMeterExecutor(ExecutorTestCase):
    ...
    def test_resource_files_collection_remote_prov(self):
        ...
        self.assertEqual(3, len(self.obj.execution['files']))
            ...
            "scenario": {
                ...
                "requests": [
                    ...
                    },
                    {
                        ...
                        "wait-for": {
                            "sync": "10",
                            "cursor": {"position": "5,8", "timeout": "120"},
                            "silent": {"stable-time": "14", "timeout": "15"},
                            "text": {"regex": ".+", "timeout": "15", "search-area": "5,5,5,5"}
                        },
                        "label": "RTE Action",
                        "attention-key": "ENTER",
                        ...
                        "fields": [
                            {"tabs": "0", "text": "MyHost", "row": "1", "col": "4", "label": "host"}
                        ]
                    }
                ]
            }
